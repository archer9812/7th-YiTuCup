...
<div class="header">
    <div class="content-wrapper">
        <div class="avatar">
            <img width="64" height="64" src="../../static/home/img/seller_avatar_5F256px.jpg">
        </div>
        <div class="content">
            <div class="title">
                <span class="brand"></span>
                <span class="name">双合元饺子馆</span>
            </div>
            ...
            <div class="support">
                ...
                <span class="text">在线支付9折</span>
            </div>
        </div>
    </div>
    <div class="bulletin-wrapper">
        <span class="bulletin-title"></span><span class="bulletin-text">好吃不过饺子，好吃不过双合元饺子</span>
